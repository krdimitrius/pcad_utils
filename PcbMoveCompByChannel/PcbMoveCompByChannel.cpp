...
// PcbMoveCompByChannel.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPcbMoveCompByChannelApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CPcbMoveCompByChannelApp

CPcbMoveCompByChannelApp::CPcbMoveCompByChannelApp()
{
...
// Единственный объект CPcbMoveCompByChannelApp

CPcbMoveCompByChannelApp theApp;


// инициализация CPcbMoveCompByChannelApp

BOOL CPcbMoveCompByChannelApp::InitInstance()
{
