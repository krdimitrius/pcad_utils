...
// AddDesCommon.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CAddDesCommonApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CAddDesCommonApp

CAddDesCommonApp::CAddDesCommonApp()
{
...
// Единственный объект CAddDesCommonApp

CAddDesCommonApp theApp;


// инициализация CAddDesCommonApp

BOOL CAddDesCommonApp::InitInstance()
{
