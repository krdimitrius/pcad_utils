...
#define	WWCancel(hCtl) 						SM((hCtl),HM_CANCEL,0,0L)
...
#define WW_VERSION_2 1  //Minor revision number 
#define WW_VERSION_DESIGN 1 //Flag for design-only builds 
#define WW_VERSION_DEMO		2 //Flag for demo builds
...
\***************************************************************************/
#ifndef WIDGEINT_H
typedef LPVOID	HSTREAM;

UINT WWAPI SWrite	(HSTREAM stream, LPVOID lpSrc, UINT uiBytes);
UINT WWAPI SRead	(HSTREAM stream, LPVOID lpDest, UINT uiBytes);
...
#define HBM_GETDATATYPE		    (HBM_FIRST + 35)
...
#define HEM_SETMAXTEXTLEN     (HEM_FIRST + 24)		// Sets TextMaxLen - was (EM_LIMITTEXT)
#define HEM_GETSEL            (HEM_FIRST + 25)		// Retrieves range of selected text - was (EM_GETSEL)
#define HEM_SETSEL            (HEM_FIRST + 26)		// Sets range of selected text - was (EM_SETSEL)         
#define HEM_LAST              (HEM_FIRST + 26)
...
#define HGM_GETVISROWSTART           (HGM_FIRST + 71)       // TANGO_MOD (pjm)
#define HGM_GETVISROWCOUNT           (HGM_FIRST + 72)       // TANGO_MOD (pjm)
...
#define HGN_KEY_DELETE      0x0024      // TANGO_MOD (pjm)
#define HGN_KEY_INSERT      0x0025      // TANGO_MOD (pjm)
#define HGN_KEY_UNDO        0x0026      // TANGO_MOD (pjm)
#define HGN_PASTE_BEGIN     0x0027      // TANGO_MOD (pjm)
#define HGN_PASTE_END       0x0028      // TANGO_MOD (pjm)
#define HGN_KEY_CTRL_UP     0x0029      // TANGO_MOD (pjm)
#define HGN_KEY_CTRL_DOWN   0x002A      // TANGO_MOD (pjm)
