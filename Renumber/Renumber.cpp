...
// Renumber.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CRenumberApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CRenumberApp

CRenumberApp::CRenumberApp()
{
...
// Единственный объект CRenumberApp

CRenumberApp theApp;


// инициализация CRenumberApp

BOOL CRenumberApp::InitInstance()
{
