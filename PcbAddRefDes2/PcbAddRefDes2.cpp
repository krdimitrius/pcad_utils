...
// PcbAddRefDes2.cpp : Определяет поведение классов для приложения.
//
...
// CPcbAddRefDes2App
BEGIN_MESSAGE_MAP(CPcbAddRefDes2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CPcbAddRefDes2App

CPcbAddRefDes2App::CPcbAddRefDes2App()
{
...
// Единственный объект CPcbAddRefDes2App

CPcbAddRefDes2App theApp;


// инициализация CPcbAddRefDes2App

BOOL CPcbAddRefDes2App::InitInstance()
{
