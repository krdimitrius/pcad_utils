...
// ComponentList.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CComponentListApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CComponentListApp

CComponentListApp::CComponentListApp()
{
...
// Единственный объект CComponentListApp

CComponentListApp theApp;


// инициализация CComponentListApp

BOOL CComponentListApp::InitInstance()
{
